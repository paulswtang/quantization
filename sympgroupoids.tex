...
\section{Groupoids}
There are two equivalent definitions of the notion of a groupoid --- one is a traditional set-theoretic definition and the other defines them as a certain type of category. First, the traditional definition:
...
The category-theoretic definition is much easier to state:
\begin{defn}
